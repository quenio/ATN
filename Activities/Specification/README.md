...
## [ModelContextProtocol](../../Examples/Protocols/ModelContextProtocol)

A larger `atn spec` example and test based on the Model Context Protocol specification, including a local source copy and a generated ATN version under [`Examples/Protocols`](../../Examples/Protocols).
...
- [`../../Examples/Protocols/ModelContextProtocol`](../../Examples/Protocols/ModelContextProtocol): a larger end-to-end example and stress test based on the Model Context Protocol specification.
